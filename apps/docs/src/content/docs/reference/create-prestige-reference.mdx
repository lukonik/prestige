---
title: Prestigia CLI Reference
description: Reference for the Prestigia CLI package.
---

# Prestigia CLI Reference

`@prestigia/cli` scaffolds a new Prestige project. It guides you through a short interactive setup and creates a TanStack Start app with Prestige already configured.
...
```bash
pnpm dlx @prestigia/cli@latest
```

### yarn

```bash
yarn dlx @prestigia/cli@latest
```

## Interactive Prompts

When you run the Prestigia CLI, it prompts you for:
