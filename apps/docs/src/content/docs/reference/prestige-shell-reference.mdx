...
```tsx
import { PrestigeShell, type PrestigeShellProps } from "@prestigia/docs/ui";
...
Type: [`PrestigeHeaderLink[]`](#prestigeheaderlink)
...
- `beforeHeaderLinks` and `afterHeaderLinks` are arrays of `{ to, label }` links.
