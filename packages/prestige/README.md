...
For more information, please visit our [official website](https://lukonik.github.io/prestigia/).
...
```bash
npx @prestigia/cli@latest my-docs
# or
pnpm dlx @prestigia/cli@latest my-docs
```
