...
component plus a Vite optimizer plugin that automatically qqeqe static assets.
Depending on whether your image is local or fetched from a CDN, you can choose
the integration that fits best. The quick examples below give you a taste of the
project.
...
<img
  ...
  alt="Hero image"
  srcset="
    /@oh-images/breakpoint-16-deab89be27aab77b-d9c45d4b5795047a-hero.webp     16w,
